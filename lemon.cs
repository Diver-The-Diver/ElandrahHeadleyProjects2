...
public class LemonadeStand
{
    ...
    {
        double costOfLemonade = .50;
        int soldLemonade = 70;
        decimal decimalProduct = .50m * 70;
        Console.WriteLine("Lemonade Price .50 cents");
        Console.WriteLine("Lemonade Total: " + decimalProduct);
    ...
    {
        decimal decimalProduct = 1.00m * 80;
        Console.WriteLine("Lemonade Price 1.00 dollar");
        Console.WriteLine("Cookie Total: " + decimalProduct);
    }
